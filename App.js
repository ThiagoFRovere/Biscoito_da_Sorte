...
import { SafeAreaView, ScrollView, StatusBar, StyleSheet, Text, useColorScheme, View, Button, Image, TouchableOpacity } from 'react-native';
...
function App(){
  ...
  return(
    <View style={styles.Container}>
      ...
      <TouchableOpacity style={[styles.botao, {marginTop: 15, borderColor: '#000000'}]} onPress={ reiniciar }>
        <View style={styles.btnArea}>
